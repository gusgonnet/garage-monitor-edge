...
void Ruuvi::toJson(JSONWriter *writer) const
{
    ...
    writer->name("pressure").value(getPressure());
    writer->name("accelerationX").value(getAccelerationX());
    writer->name("accelerationY").value(getAccelerationY());
    writer->name("accelerationZ").value(getAccelerationZ());
    writer->name("batteryVoltage").value(getBatteryVoltage());
    writer->name("txPower").value(getTxPower());
    writer->name("movementCounter").value(getMovementCounter());
    writer->name("measurementSequenceNumber").value(getMeasurementSequenceNumber());
    writer->endObject();
}
